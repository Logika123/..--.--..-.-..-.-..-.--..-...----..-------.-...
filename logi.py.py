...
class MainWindow(CTk):
    ...
    def adaptive_ui(self):
        ...
        self.message_input.configure(
            width = self.winfo_width()*0.81 - self.frame.winfo_width() -
                    self.send_button.winfo_width())

        self.message_input.place(x = self.frame.winfo_width()*0.81,
                    y = self.winfo_height()*0.81 - self.send_button.winfo_height())

        self.send_button.place(
            x = self.winfo_width()*0.81 - self.send_button.winfo_width(),
            y = self.winfo_height()*0.81 - self.send_button.winfo_height())
